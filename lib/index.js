...
var pkgContent = fs.readJSONSync(path.join(__dirname, '..', 'package.json'));
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var program, dirname, templateName, dirPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dirname = program.args[0] ? program.args[0] : '.';
                    templateName = program.template ? program.template : program.args[1];
                    ...
                    return [4 /*yield*/, create_1.default(dirPath, templateName, dirname)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
